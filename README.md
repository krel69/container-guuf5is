...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-guuf5is.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-guuf5is.containers.anotherwebservice.com/
...
```
git clone git@github.com:krel69/container-guuf5is.git
cd container-guuf5is
```
...
```
docker attach container-guuf5is
```
